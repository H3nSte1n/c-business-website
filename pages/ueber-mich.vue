      ...
      teasers: [
        {
          ...
          content: {
            ...
            desc_1: 'Mich interessiert einfach das Dazwischen. Meistens ist es nicht sichtbar, aber es schwingt in jeder Geste mit. Das kann ein versteckter Wunsch, eine stille Leidenschaft oder eine verborgene Stärke sein. Wenn diese heimlichen Schätze sichtbar werden, ist etwas passiert. Nein kein Wunder, aber eine wohlwollende Umgebung, die es möglich macht.\n\n Goethe hat das schon sehr früh erkannt:',
            desc_2: 'Behandle die Menschen so, als ob sie das wären, was sie sein könnten. Und hilf ihnen das zu werden, was sie sein könnten.“'
          }
        },
        {
          color: "yellow",
