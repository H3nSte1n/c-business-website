...
export default {
  ...
  methods: {
    ...
    animateBoxHeight(animateElement) {
      ...
      const animationLimes = !this.scrollUp
        ? animateElement.offsetHeight <= document.documentElement.clientHeight
        : animateElement.offsetHeight >= this.elementHeight[elementCount];
